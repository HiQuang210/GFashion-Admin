...
interface AddProductDataProps {
  isOpen: boolean;
  setIsOpen: React.Dispatch<React.SetStateAction<boolean>>;
}

const AddProductData: React.FC<AddProductDataProps> = ({ isOpen, setIsOpen }) => {
  // Modal state
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    toast('Product creation not allowed yet');
  };
            ...
            <div className="w-full flex flex-col items-start gap-3">
              ...
              <div className="avatar">
                <div className="w-24 rounded">
                  <img src={preview} alt="product-upload" />
                </div>
              </div>
            </div>
          )}
